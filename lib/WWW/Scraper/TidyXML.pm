...
sub getTidyVersion {
    ...
    unless ( $WWW::Scraper::TidyXML::DaveRaggettVersion ) {
        ...
        if ( $? ) {
            ...
            elsif ( $rslt =~ m{HTML Tidy release date: 30th April 2000} ) {
                $WWW::Scraper::TidyXML::DaveRaggettVersion = 1;
            } 
            else {
...
=item To Dave Raggett <dsr@w3.org> (original author), and to Tor-Ivar Val�mo, and his SourceForge team, for TidyHTML.
